...
INSERT INTO `store_items` (`id`, `type`, `price`, `display`, `description`, `value`) VALUES
	(1, 'ctplayermodel', 100, 'Captain America', 'A skin of Captain America. ', 'models/player/captain_america.mdl'),
	(2, 'tplayermodel', 150, 'Captain America but black', 'Black Captain America. This nigga smiling', 'models/player/captain_america_black.mdl'),
